...
def lambda_handler(event, context):
    ...
    if subscriberConfig:
        ...
        vgwAsn = deleteVgw(result['VgwId'], vpcId, event['queryStringParameters']['Region'])

        event['queryStringParameters']['Action'] = 'DeleteTransitVpnConfiguration'
        ...
        try:
            if cgw1Id: deleteCgw(cgw1Id, event['queryStringParameters']['Region'])
            if cgw2Id: deleteCgw(cgw2Id, event['queryStringParameters']['Region'])
        except Exception as e:
